...
public interface ContactService {
    ...
    List<Contact> getContacts(String start, String end, String page, String email, String mobile, String firstName, String lastName, String searchParam) throws Exception;
